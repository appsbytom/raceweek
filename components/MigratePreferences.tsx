        ...
        <div className="flex h-3/4 items-center justify-center p-4">
          <Dialog.Panel className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-xl">
            ...
            <div className="mt-4 flex gap-2 sm:justify-end">
              ...
              <button
                className="w-full flex items-center justify-center rounded-md border border-transparent shadow-sm px-4 py-2 font-medium text-white bg-red-600 sm:w-auto hover:enabled:bg-red-700 disabled:cursor-not-allowed disabled:opacity-75"
                onClick={transfer}
                disabled={isSaving}
              >
